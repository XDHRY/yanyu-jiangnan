...
VIEWS=[
    ...
    ('02_front_gate',(1.4,-19,4.8),(1.4,4.5,2.25),42,0,'正面轴线：汀步到月门的连续性、门洞尺度、远景借景'),
    ('03_pavilion_entry',(-7,-8,3.0),(-7,1.1,1.9),45,0,'听雨轩入口：台基、踏步、柱网与茶案尺度'),
    ...
    ('06_gate_reverse',(1.4,11,4.2),(1.4,3.2,2.1),45,0,'月门背面：门后石径、庭院回望与真实通行关系'),
    ('07_east_return',(15,-1,4.0),(8.5,2.0,2.0),52,0,'东墙：转角、漏窗、岸线和侧向空间是否拥挤'),
    ('08_roofline',(14,-16,13),(0,2.0,3.0),52,0,'高位轮廓：屋顶、墙顶、梅树与远山是否层叠而非齐平'),
    ('09_pavilion_side',(-15,1.0,4.0),(-7,1.2,2.0),50,0,'轩侧：柱梁支撑、屋檐出挑和台基比例'),
    ('10_eye_path',(0,-.8,1.65),(1.4,5.2,2.25),50,0,'人眼高度：从庭院步向月门时的遮挡、尺度和视线终点'),
]
